...
class Development:
    ...
    LOGGER = True
    BOT_TOKEN = "7719275492:AAGZtpfrUUnoIeM7-NlXYJzwuWO-670grGA"
    ...
    MESSAGE_DUMP = -1002313685897  # Your Private Group ID for logs if not passed your owner id will be msg dump
    DEV_USERS = []
    SUDO_USERS = []
    WHITELIST_USERS = []
